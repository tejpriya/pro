...
class PasswordResetTokenGenerator:
    ...
    def check_token(self, user, token):
        ...
        #print("AAAAAAAAAAAAAAAAAAAAAAAA : ",self._num_seconds(now) - ts,settings.PASSWORD_RESET_TIMEOUT)
    ...
    def _make_hash_value(self, user, timestamp):
        ...
        return f'{user.pk}{user.user_password}{login_timestamp}{timestamp}{email}'
